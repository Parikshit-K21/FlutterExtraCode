...
class MenuManagementPage2 extends StatefulWidget {
  ...
  const MenuManagementPage2({super.key, required this.roleName, required this.jsonData});
...
Future<void> _saveToDataFile() async {
  try {
    ...
    final file = File('$path/lib/data.dart');
